...
public class MoltenLeadBlock extends Block implements BucketPickup {
    public MoltenLeadBlock() {
        super(BlockBehaviour.Properties.of((new Material.Builder(MaterialColor.COLOR_PURPLE)).noCollider().nonSolid().build())
    ...
    public boolean skipRendering(BlockState p_60532_, BlockState p_60533_, Direction p_60534_) {
        return p_60533_.is(this) || super.skipRendering(p_60532_, p_60533_, p_60534_);
    }
