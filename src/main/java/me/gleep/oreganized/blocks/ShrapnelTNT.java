...
public class ShrapnelTNT extends Block {
    ...
    public void onExplosionDestroy(World worldIn, BlockPos pos, Explosion explosionIn) {
        if (!worldIn.isRemote) {
            ShrapnelTNTEntity tntentity = new ShrapnelTNTEntity(worldIn, (double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D, explosionIn.getExplosivePlacedBy());
    ...
    private static void explode(World worldIn, BlockPos pos, @javax.annotation.Nullable LivingEntity entityIn) {
        if (!worldIn.isRemote) {
