...
public class OreganizedConfiguredFeatures{
    ...
    public static void registerConfiguredFeatures(){
        ...
        ORE_SILVER_DEEP_UNDERGROUND = Feature.ORE.configured( new OreConfiguration( ORE_SILVER_TARGET_LIST , 14 ) );
        ORE_SILVER = Feature.ORE.configured( new OreConfiguration( ORE_SILVER_TARGET_LIST , 9 ) );
        ORE_LEAD_DEEP_UNDERGROUND = Feature.ORE.configured( new OreConfiguration( ORE_LEAD_TARGET_LIST , 13 ) );
        ORE_LEAD = Feature.ORE.configured( new OreConfiguration( ORE_LEAD_TARGET_LIST , 8 ) );
