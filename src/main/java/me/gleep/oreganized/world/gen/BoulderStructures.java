...
public class BoulderStructures extends StructureFeature<JigsawConfiguration> {

    public BoulderStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, BoulderStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        /*if (!BoulderStructures.isFeatureChunk(context)) {
