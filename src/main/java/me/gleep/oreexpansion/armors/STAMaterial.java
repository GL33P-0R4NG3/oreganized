...
public enum STAMaterial implements IArmorMaterial {
    STDA(OreExpansion.MOD_ID + ":silver_tinted_diamond", Items.DIAMOND_LEGGINGS.getDefaultInstance().getMaxDamage() / 15,
            new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F),
    STGA(OreExpansion.MOD_ID + ":silver_tinted_gold", Items.GOLDEN_LEGGINGS.getDefaultInstance().getMaxDamage() / 15,
            new int[]{1, 3, 5, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0.0F),
    STNA(OreExpansion.MOD_ID + ":silver_tinted_netherite", Items.NETHERITE_LEGGINGS.getDefaultInstance().getMaxDamage() / 15,
